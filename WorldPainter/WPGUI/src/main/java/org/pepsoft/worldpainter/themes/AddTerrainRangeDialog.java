 ...
 * @author pepijn
 */
public class AddTerrainRangeDialog extends javax.swing.JDialog {
    /** Creates new form AddTerrainRangeDialog */
    public AddTerrainRangeDialog(Frame parent, int maxHeight, ColourScheme colourScheme) {
        super(parent, true);
        this.colourScheme = colourScheme;
        init(parent, maxHeight);
    }

    /** Creates new form AddTerrainRangeDialog */
    public AddTerrainRangeDialog(Dialog parent, int maxHeight, ColourScheme colourScheme) {
        super(parent, true);
        this.colourScheme = colourScheme;
        init(parent, maxHeight);
    }
    ...
    private void init(Window parent, int maxHeight) {
        initComponents();
