...
public class AboutDialog extends javax.swing.JDialog implements WindowListener {
    ...
    private String loadTechInfo(World2 world, WorldPainter view, UndoManager undoManager) {
        ...
        String message = MessageFormat.format(strings.getString("worldpainter.version.0.njava.version.1.noperating.system.2.3.version.4.n"), Version.VERSION, System.getProperty("java.version"), System.getProperty("os.name"), System.getProperty("os.arch"), System.getProperty("os.version"));
        if (installDir != null) {
