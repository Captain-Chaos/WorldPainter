 ...
 * @author pepijn
 */
public class LegacyJavaMapImporter extends MapImporter {
    public LegacyJavaMapImporter(TileFactory tileFactory, File levelDatFile, boolean populateNewChunks, Set<Point> chunksToSkip, ReadOnlyOption readOnlyOption, Set<Integer> dimensionsToImport) {
...
//        }
    ...
    private static final org.slf4j.Logger logger = org.slf4j.LoggerFactory.getLogger(LegacyJavaMapImporter.class);
