...
public class NotPresent extends Layer {
    private NotPresent() {
        super(NotPresent.class.getName(), "Not Present", "Mark chunks that were not present in the map from which the world was imported", DataSize.BIT_PER_CHUNK, true, 91);
    }
