...
public class Plants {
    ...
    public static final Plant PINK_PETALS = new PlantWithGrowth("Pink Petals", Material.PINK_PETALS_1, "block/pink_petals.png", 4, PLANTS_AND_FLOWERS) {
        @Override
        public Plant realise(int growth, Platform platform) {
    ...
    public static final Plant PITCHER_POD = new AgingPlant("Pitcher Pod", Material.PITCHER_CROP_0_LOWER, "item/pitcher_pod.png", 5, CROPS) {
        @Override
        public Plant realise(int growth, Platform platform) {
            if (growth < 4) {
