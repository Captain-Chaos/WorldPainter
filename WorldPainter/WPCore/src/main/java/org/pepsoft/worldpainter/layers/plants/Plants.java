...
public class Plants {
    ...
    public static final Plant GLOW_BERRIES = new VariableHeightPlant("Glow Berries", Material.CAVE_VINES_NO_BERRIES, Material.CAVE_VINES_PLANT_NO_BERRIES, "block/cave_vines_lit.png", 10, HANGING_DRY_PLANTS) {
        @Override
        public Plant realise(int growth, Platform platform) {
